...
export function useEditorBridge(
  ...
  return useMemo<EditorBridge>(() => {
    ...
    return {
      ...
      insertImage: (spec) => call("insertImage", spec) as Promise<void>,
      applyActions: (actions) => call("applyActions", actions) as Promise<void>,
      rebuildElement: (id, html) => call("rebuildElement", id, html) as Promise<void>,
      ...
      select3DLayer: () => call("select3DLayer") as Promise<boolean>,
      ...
      listSceneSections: () => call("listSceneSections") as Promise<never>,
      applySceneAssignment: (op) => call("applySceneAssignment", op) as Promise<void>,
      ...
      listSlides: () => call("listSlides") as Promise<never>,
      insertSlide: (spec) => call("insertSlide", spec) as Promise<number>,
      deleteSlide: (index) => call("deleteSlide", index) as Promise<boolean>,
      moveSlide: (from, to) => call("moveSlide", from, to) as Promise<boolean>,
